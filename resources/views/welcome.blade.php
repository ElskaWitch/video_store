		...
		<div
				...
				@if (Route::has('login'))
						<div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
								@auth
										<a class="text-sm text-gray-700 dark:text-gray-500 underline" href="{{ url('/dashboard') }}">Dashboard</a>
								@else
				...
				<div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
								...
								<div class="grid grid-cols-1 md:grid-cols-2">
										<div class="p-6">
												<div class="flex items-center">
														<svg class="w-8 h-8 text-gray-500" fill="none" stroke-linecap="round" stroke-linejoin="round"
										...
										<div class="p-6 border-t border-gray-200 dark:border-gray-700">
												<div class="flex items-center">
														...
														<div class="ml-4 text-lg leading-7 font-semibold"><a class="underline text-gray-900 dark:text-white"
																		href="https://laravel-news.com/">Laravel News</a></div>
												</div>
										...
										<div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
												...
												<div class="ml-12">
														<div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
																Laravel's robust library of first-party tools and libraries, such as <a class="underline"
																		href="https://forge.laravel.com">Forge</a>, <a class="underline"
																		href="https://vapor.laravel.com">Vapor</a>, <a class="underline"
																		href="https://nova.laravel.com">Nova</a>, and <a class="underline"
																		href="https://envoyer.io">Envoyer</a> help you take your projects to the next level. Pair them with
																powerful open source libraries like <a class="underline"
																		href="https://laravel.com/docs/billing">Cashier</a>, <a class="underline"
																		href="https://laravel.com/docs/dusk">Dusk</a>, <a class="underline"
																		href="https://laravel.com/docs/broadcasting">Echo</a>, <a class="underline"
																		href="https://laravel.com/docs/horizon">Horizon</a>, <a class="underline"
																		href="https://laravel.com/docs/sanctum">Sanctum</a>, <a class="underline"
																		href="https://laravel.com/docs/telescope">Telescope</a>, and more.
														</div>
												</div>
										</div>
								</div>
						...
						<div class="flex justify-center mt-4 sm:items-center sm:justify-between">
								<div class="text-center text-sm text-gray-500 sm:text-left">
										<div class="flex items-center">
												<svg class="-mt-px w-5 h-5 text-gray-400" fill="none" stroke-linecap="round" stroke-linejoin="round"
														stroke-width="2" stroke="currentColor" viewBox="0 0 24 24">
														<path
												...
												<svg class="ml-4 -mt-px w-5 h-5 text-gray-400" fill="none" stroke-linecap="round"
